...
- [Arquitetura Proposta](#arquitetura-proposta)
  - [Execução do projeto](#execução-do-projeto)
    - [01 - Execução geral via docker-compose](#01---execução-geral-via-docker-compose)
    - [02 - Execução geral via automação com script em Python](#02---execução-geral-via-automação-com-script-em-python)
    - [03 - Executando os serviços de bancos de dados e Message Broker](#03---executando-os-serviços-de-bancos-de-dados-e-message-broker)
